...
#5. Multuplication of each element:
...
#11. Python program that accepts a string and calculatethe numberof digits and letters:
...
#24. Pyhton program that accepts a string and calculatethe number of digits, letters and space: 
